...
'data/4-expression-ratios.tsv' |>
  read_tsv() |>
  # zFPKM on RPKM data expressed
  filter(method == 'RPKM') |>
  select(- method) |>
  # only on motifs
...
html`Alignment: <a href="https://rth.dk/resources/crs/cyanobacteria/data/motifs/${sel}.sto">Download</a> | <a href="https://rth.dk/resources/crs/cyanobacteria/msa.html?candidate=${sel}">View</a>`
