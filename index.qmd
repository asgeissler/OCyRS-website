...
relative to the bacterial *reference RNA structure* families provided in
[Rfam](https://rfam.org/) database with
the 
[CMsearch](http://eddylab.org/infernal/) tool.
Subsequently, we predict that detected RNA structure without
overlap to the references are *candidates for novel RNA structures*.
